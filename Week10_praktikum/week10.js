...
console.log(greetGuest(guestName));
...
function calculateAge(a = 2023, b = 1985) {
	return a - b;
}

console.log(
	'Моему другу сейчас ' + calculateAge() + ' лет'
);
//Задание 17
...
const age = calculateMyAge(yearOfBirth);
console.log(age);
